                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                <?php foreach ($cabang->result_array() as $row) {?>
                                    ...
                                    <tr>
                                        <?php $latitude = $row['latitude'];$longitude = $row['longitude'] ?>
                                        <?php if ($latitude == null AND $longitude == null){ ?>
                                            
                                        <?php }else{ ?>
                                        <td>Lokasi</td>
                                        <td>:</td>
                                        
                                        <td><a target="_BLANK" href="https://maps.google.com/maps?&z=15&mrt=yp&t=k&q=<?= $latitude . ',' . $longitude ?>">Lihat Lokasi</a></td>
                                    <?php } ?>
                                    </tr>
                                <?php } ?>
                            </table>
