                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>Rp. <?= number_format($tPenam->totalPenambahan - $tPot->totalPotongan - $biayaTerlambat - $biayaAlpa,0,',','.') ?></td>
                                    <td>
                                        <?php
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#kirimGaji<?= $row['id'] ?>">
                                            <div class="fa fa-send"></div> Kirim Gaji
                                        </button>
                                        <a href="<?= base_url('index.php/admin/gaji/setting/').$row['id'] ?>" class="btn btn-success btn-xs">
                ...
                <form action="<?= base_url('index.php/admin/gaji/kirimgaji/').$kirim->id ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <font color="red">
                                <small>NB : Alpa dan Terlambat akan dihitung otomatis berdasarkan bulan dan tahun pada tanggal yang dipilih ketika klik <b>save</b>!</small>
                            </font>
                        </div>
                    </div>
