            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('index.php/admin/cabang/update/').$edit->id ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                        <label>Latitude</label>
                        <input type="text" name="latitude" class="form-control" value="<?= $edit->latitude ?>" placeholder="Latitude" required>
                    </div>
                    <div class="form-group">
                        <label>Longitude</label>
                        <input type="text" name="longitude" class="form-control" value="<?= $edit->longitude ?>" placeholder="Longitude" required>
                    </div>
                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-danger"><div class="fa fa-trash"></div> Reset</button>
